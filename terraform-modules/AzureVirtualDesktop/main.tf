data "azurerm_image" "search" {
  name                = "packer-windows-image-1.0.0"
  resource_group_name = "PackerImage"
}

output "image_id" {
  value = "/subscriptions/890c8b4a-e9fc-448c-a68e-7a0d35f11f22/resourceGroups/PackerImage/providers/Microsoft.Compute/images/packer-windows-image-1.0.0"
}
...
resource "azurerm_network_interface" "wvd_vm1_nic" {
  ...
  ip_configuration {
    name                          = "TFip"
    subnet_id                     = "/subscriptions/890c8b4a-e9fc-448c-a68e-7a0d35f11f22/resourceGroups/PackerImage/providers/Microsoft.Network/virtualNetworks/vm1-vnet/subnets/default"
...
resource "azurerm_virtual_machine_extension" "avd_register_session_host" {
  ...
  depends_on = [azurerm_windows_virtual_machine.wvd_vm1]
}
